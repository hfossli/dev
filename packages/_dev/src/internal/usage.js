...
function usage(appEntries = [], toolEntries = []) {
  ...
  return [
    "Usage:",
    "  _dev start <app|all> [-a|--attach] [--lines <n>]",
    "  _dev restart <app|all> [-a|--attach] [--lines <n>]",
    "  _dev stop <app|all>",
    "  _dev attach [app] [--lines <n>]",
    ...
    "Examples:",
    "  npx _dev start api",
    "  npx _dev start api -a",
    "  npx _dev start all --attach --lines 200",
    "  npx _dev attach",
    "  npx _dev attach web",
    "  npx _dev restart all -a",
    "  npx _dev stop all",
